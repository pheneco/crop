			...
			this.render                = function() {
				...
				if(this.square) {
					if(this.y2 - this.y1 < this.x2 - this.x1) {
						if(this.cutting || this.rsz_se || this.rsz_ne) this.x2 = this.x1 + (this.y2 - this.y1);
						if(this.rsz_nw  || this.rsz_sw)                this.x1 = this.x2 - (this.y2 - this.y1);
					} else {
						if(this.cutting || this.rsz_sw || this.rsz_se) this.y2 = this.y1 + (this.x2 - this.x1);
						if(this.rsz_nw  || this.rsz_ne)                this.y1 = this.y2 - (this.x2 - this.x1);
					}
				}
